...
public class WidgetEventSystem
{
	...
	public static WidgetEventSystem instance
	{
		get {
			if (mInstance == null) {
				mInstance = new WidgetEventSystem ();
			}
			return mInstance;
		}
	}
